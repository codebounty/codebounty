...
requirejs(["server"],
    function (server) {
        var thisIssueUrl = encodeURI(window.location.href);
        ...
        var ui = {
             ...
             */
            initializeAuthenticatedUser: function () {
                ui.setupOverlay();
                ui.setupContainer();
        ...
        server.connect(onConnected, onAuthenticated, onAuthorized);

//        var onConnected = function () {
//            //subscribe and watch to the total reward for this issue
//            ddp.subscribe("totalReward", [thisIssueUrl]);
//            ddp.watch("totalReward", function (message) {
